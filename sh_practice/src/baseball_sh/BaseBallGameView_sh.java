...
public class BaseBallGameView_sh {
	BaseBallGameLogic_sh bbLogic = new BaseBallGameLogic_sh();
	...
	public BaseBallGameView_sh(String result[]) {
		this.result = result;
		if(this.result==null) {
	...
	public void initDisplay() {
		...
		BaseBallGameEvent_sh bbEvent = new BaseBallGameEvent_sh(this);
