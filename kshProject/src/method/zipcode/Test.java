...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(new Test().setName()+new Test());
		//메소드를 통해서 객체를 생성하므로 null인 경우만 새로 생성하고
		//기존에 유지되고 있다면 새로 생성하지 않음.
		System.out.println(Test.getInstance().setName()+Test.getInstance());
	}
}
