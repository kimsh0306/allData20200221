...
/*
 * TestParam.java 소스안에 두 개 클래스를 가짐.
 ...
 * 두번째 변화 주기
 * 20번 주석이 있을때와 없을 때 결과에 차이가 있다|없다.
...
public class TestParam {
	void effectParam(Param p) { //원본을 받았으나
		...
		p.ival = 500;    //(윗줄 정상작동시)복제본이 500으로 변경
		System.out.println("sub ival ==>"+p.ival);
	}
	/* 31(entry-point)-34(객체가 램에 상주하게됨:인스턴스화)-35(전변초기화-0)-36(100)
	 * 37(파라미터로 원본)-22(35번 객체가리킴)-24(원본이 바뀜)[0-100-500]-25-26-38
	 */
	...
	public static void main(String[] args) {
		...
		Param p = new Param(); //지변이지만 원본 변수p의 주.번
		p.ival=100;
