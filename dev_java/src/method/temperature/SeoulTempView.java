...
public class SeoulTempView implements ActionListener {
	...
	//오라클에는 일꾼이 살고 있는데 이름은 '옵티마이저'라고 함.
	...
	//파라미터의 갯수에 따라서 서로 다른 생성자를 선언한느 것도 가능하다는 것인가?
	...
	JFrame				jf_zip		= new JFrame();//운영체제 위에 창을 띄운다.
...
//		SeoulTempVO[] stVOS = new SeoulTempVO[2];
//		
...
//		stVO.setMitemp(5);
//		stVOS[0] = stVO;
//		System.out.println(stVO.getLoc());
//		System.out.println(stVOS[0].getLoc());
//		
//		stVO = null;
...
//		stVOS[1] = stVO;
//		stVO = null;
//		System.out.println(stVOS[0].getMatemp()); //?
//		System.out.println(stVOS[1].getMatemp()); //?
//		System.out.println(stVOS[0].getMitemp()); //?
//		System.out.println(stVOS[0].getLoc()); //?
	...
	public void initDisplay() {
		System.out.println("initDisplay 호출 성공");
			...
			//이렇게 동,서,남,북,중앙에 버튼을 배체하고 싶으면 BorderLayout 사용함.
			...
			//JFrame 판넬 위에 북쪽에 jp_north 속지를 붙이자.
