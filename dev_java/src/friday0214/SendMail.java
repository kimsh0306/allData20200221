...
public class SendMail {
	...
	public static void main(String[] args) {
		...
		int smtpPort = 465;
		//보내는 사람 정보
		final String sendId = "54core";			//네이버 계정 아이디
		final String sendPass = "tmrus0306";	//네이버 계정 비번
		String sendEmailAddress = "54core@naver.com";
		...
		//받는 쪽 정보
		String receiveEmailAddress = "b666790@gmail.com";
